  ...
  return (
    <>
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-bold">Création de cours</h1>
      </div>
      <Card>
        <CardHeader>
          <CardTitle>Information Basic</CardTitle>
          <CardDescription>
            Fournir des informations de base sur le cours
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
              ...
              >
                {isPending ? (
                  ...
                  <>
                    Créer le cours <PlusIcon className="ml-1" size={16} />
                  </>
                )}
              </Button>
            </form>
